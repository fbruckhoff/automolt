...
related: ../../CONTRIBUTING.md, core-beliefs.md
---
...
Use the repository-root [`CONTRIBUTING.md`](../../CONTRIBUTING.md) as the authoritative contributor guide for all development environment setup, commit conventions, allowed scopes, and release workflow.
